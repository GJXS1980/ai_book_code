...
class XML_Analysis():
    def __init__(self):
        ...
        self.sub = rospy.Subscriber('/voice/castlex_xiaogu_cmd_topic', Int32 , self.cmd_callback)
        self.cmd_vel_pub = rospy.Publisher('/cmd_vel', Twist, queue_size = 1)     #发布速度话题
    ...
    def Process_Speech_cmd_to_Speed(self):
        ...
        if (self.command_id==306):
            ...
            if self.result_confidence_data[self.focus_data.index('commands')]>30:
